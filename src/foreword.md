...
儘管如此，我還是建議學習者一章一章閱讀本教學，如果你有靜態語言的基礎，你或許可以跳過第一章，但我更推薦的方法還是簡單花幾分鐘掃過第一章之後再往後繼續閱讀。如果是初學者就更不用說了。當然，如果你不怕漏掉什麼內容的話，你也可以直接跳到有興趣的部分看，或者是使用搜尋功能跳到教學後面才給的解釋提前閱讀，這些都是可行的做法。啊文中有章附錄一，雖然叫作附錄但也希望讀者能全部觀看。
