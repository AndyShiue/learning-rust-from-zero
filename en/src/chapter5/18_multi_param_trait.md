...
Our `trait`s so far have been fairly simple — `Clone`, `Display`, `Describe`, no extra type parameters. But sometimes the behavior you want to define relates to **another type**.
